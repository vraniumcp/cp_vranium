...
void solve(){
    Rect sp1, sp2;
    read(sp1.x1,sp1.y1,sp1.x2,sp1.y2,sp2.x1,sp2.y1,sp2.x2,sp2.y2);
    int x_dist = max(sp1.x2,sp2.x2) - min(sp1.x1,sp2.x1);
    int y_dist = max(sp1.y2,sp2.y2) - min(sp1.y1,sp2.y1);
    cout << max(x_dist,y_dist)*max(x_dist,y_dist);
}
